...
public:
	...
	inline void ClampYawInPlace(float minvalue, float maxvalue)
	{
		yaw = std::max(minvalue, std::min(yaw, maxvalue));
	}

	inline void ClampPitchInPlace(float minvalue, float maxvalue)
	{
		pitch = std::max(minvalue, std::min(pitch, maxvalue));
	}

	inline void ClampRollInPlace(float minvalue, float maxvalue)
	{
		roll = std::max(minvalue, std::min(roll, maxvalue));
	}
